      ...
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          ...
          <p className="text-white max-sm:text-sm">
            Introducing the smartwatch that redefines the future of wearable technology. Packed with innovative features, seamless design, and cutting-edge performance, it's everything you need to stay connected and on top of your goals.
          </p>
          <div className="flex gap-x-1 max-lg:flex-col max-lg:gap-y-1">
            <button className="bg-white text-blue-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
              BUY NOW
            </button>
            <button className="bg-white text-blue-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
              LEARN MORE
