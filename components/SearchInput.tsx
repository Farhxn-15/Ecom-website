  ...
  return (
    <form className="flex w-full justify-center" onSubmit={searchProducts}>
      <input
        ...
        className="bg-gray-50 input input-bordered w-[70%] rounded-r-none outline-none focus:outline-none max-sm:w-full hover:scale-105 transition-all duration-300 ease-in-out shadow-md hover:shadow-lg"
      />
      <button
        type="submit"
        className="btn bg-blue-500 text-white rounded-l-none rounded-r-xl hover:bg-blue-600 hover:scale-105 transition-all duration-300 ease-in-out shadow-md hover:shadow-lg"
      >
        Search
      </button>
    </form>
